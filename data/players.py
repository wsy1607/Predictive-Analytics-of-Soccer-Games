...
#the html source code for different year has different patterns, we have to read data separately
#read premier league players data
filename = 'premierplayers.txt'
txt = open(filename)
data1 = txt.read()
...
#read laliga league players data
filename = 'laligaplayers.txt'
txt = open(filename)
data1 = txt.read()
data2 = data1.split('DataStore.prime')
data3 = data2[1].split('}]]);')[0]
...
#read serieA league players data
filename = 'serieAplayers.txt'
txt = open(filename)
data1 = txt.read()
data2 = data1.split('DataStore.prime')
data3 = data2[1].split('}]]);')[0]
...
#read bundesliga league players data
filename = 'bundesligaplayers.txt'
txt = open(filename)
data1 = txt.read()
data2 = data1.split('DataStore.prime')
data3 = data2[1].split('}]]);')[0]
...
#read french league players data
filename = 'frenchplayers.txt'
txt = open(filename)
data1 = txt.read()
data2 = data1.split('DataStore.prime')
data3 = data2[1].split('}]]);')[0]
